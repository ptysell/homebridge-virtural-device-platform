 ...
 */
export class VDPHomebridgePlatform implements DynamicPlatformPlugin {
    ...
    discoverDevices() {
        ...
        for (const room of exampleDevices) {
            ...
            if (existingRoomAccessory) {
                ...
                roomAccessory = new VDPRoomAccessory(this, accessory);
